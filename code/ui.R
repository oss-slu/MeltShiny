...
# 🔗 Source individual tab files
source("ui_parts\file_tab.R")      # Loads file_tab
source("ui_parts\analysis.R")  # Loads analysis_tab
source("ui_parts\results.R")   # Loads results_tab
source("ui_parts\help.R")      # Loads help_tab

# 🧩 Assemble the UI using navbarPage
ui <- navbarPage(
  title = "MeltShiny",
  theme = shinytheme("flatly"),
  id = "navbarPageID",
  file_tab,      # Loaded from file.R
  analysis_tab,  # Loaded from analysis.R
  results_tab,   # Loaded from results.R
  help_tab       # Loaded from help.R
)
