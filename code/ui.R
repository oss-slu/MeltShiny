  ...
  tabPanel(
    ...
    fluidPage(
      mainPanel(
        ...
        HTML("Each processed dataset will appear as a seperate table with unique captions and entry numbers. There will be five columns- row number, Sample, Pathlength, Temperature, and Absorbance. 
        ...
        HTML("The help page will always be available should you need to reference it at any point.</li>"), 
        HTML("The upload tab under the File menu will also be available after you have indicated you are done uploading. The inputs on the left will be disabled, but you can still
        ...
        HTML("For each dataset you upload, enter the pathlengths for each sample as a comma separated list with no spaces.</li>"), 
        hr(style = "border-top: 1px solid #000000;"),
        h4("Applicable to all datasets:"),
        HTML("Use the drop down menu to select the wavelength in nm. By default, the value will be 260. Note, that for DNA, only a wavelength of 260 is allowed.</li>"), 
        HTML("Use the drop down menu to select the temperature used to calculate the concentration with Beers law.
                                   By default, the value will be 90.</li>"),
        HTML("Enter the extinction coefficient information in the following format- nucleic acid, an appropriate sequence for that nucleotide, and, if applicable, its complement.</li>"), 
        HTML("Decide if you want to use methods 2 and 3. If method 2 is unselected, the Vant Hoff plot will not be generated. By default, both optional methods are selected.</li>"), 
        HTML("Decide which Tm method to use. Either nls to use the Tms from the fits in Method 1, lm to use a numeric method based on linear regression of fraction
        ...
        HTML("If you chose the nls method for Tm method and method 2 was selected, you have the option to turn on weighted non-line regression for method 2.
        ...
        HTML("Use the drop down menu to select the molecular model you want to fit. By default Heteroduplex is chosen.</li>"), 
        HTML("Hit the browse button and use the file manager select the data file from your computer. The file should be of csv format.
        ...
        HTML("Select the checkbox at the very bottom of the sidepanel to indicated you are done uploading datasets.</li>"), 
        HTML("The Analysis and Results tabs will be enabled after all the datasets have been uploaded.</li>"), 
        hr(style = "border-top: 1px solid #000000;"),
        h3("ANALYSIS GRAPHS:"),
        hr(style = "border-top: 1px solid #000000;"),
        ...
        HTML("To view the graph of a specific sample, click on the tab labeled with the sample number.</li>"), 
        HTML("The best fit and first derivative lines can be shown on the graph by toggling the checkboxes. A marker for the maximum of the first derivative is always shown.</li>"), 
        HTML("The range slider on the bottom of each graph is used to indicate the minimum and maximum values you would like considered when indicating a region for fitting.
                                   Note, the graph region will show only the selected range on the slider.</li>"), 
        hr(style = "border-top: 1px solid #000000;"),
        h3("FITTING THE ANALYSIS GRAPHS:"),
        hr(style = "border-top: 1px solid #000000;"),
        h3("Van't Hoff Plots:"),
        HTML("The van't hoff page under results shows the van't hoff plot</li>"), 
        HTML("You may click individual points to remove them from the plot.</li>"), 
        HTML("To remove multiple points in one go you can click and drag on the graph to make a box.
        ...
        HTML("If you want to restore the plot back to the original version, press the restore button on the side panel.</li>"), 
        HTML("To save the version of the plot, enter enter a name in the box, choose the file format, and hit the download button.
        ...
        HTML("To save the version of the table, enter enter a name in the box, choose which parts of the table to save, choose the file format,
