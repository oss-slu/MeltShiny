  ...
  fluidPage(
    ...
    mainPanel(width = 12,  # Set full width for the Help page
      ...
      div(id = "general_info_content", hidden = TRUE,
        ...
        div(img(src = "Upload_Processed.png", class="img-half", alt = "Screenshot showing the general information of the upload page", style = "clear:both")),
        ...
        div(img(src = "Navigation_Entries.png",class="img-half", alt = "Screenshot showing the entries and navigation", style = "clear:both")),
        ...
        div(img(src = "Active_Inactive.png",class="img-half", alt = "Screenshot showing the Active and Inactive parts of Navigation bar",style = "clear:both")),
      ...
      div(id = "upload_data_content", hidden = TRUE,
        ...
        div(img(src = "Upload_Sequence.png", class="img-half", alt = "Screenshot showing the Upload , blank and sequences sections",style = "clear:both")),
        hr(style = "border-top: 1px solid #000000;"),
        ...
        div(img(src = "Wavelength_Temp.png", class="img-half",alt = "Screenshot showing the Wavelength and Temperature",style = "clear:both")),
        ...
        div(img(src = "Coefficient.png",class="img-half",  alt = "Screenshot showing the Coefficients",style = "clear:both")),
        ...
        div(img(src = "Method.png", class="img-half",alt = "Screenshot showing the Method Selection",style = "clear:both")),
        ...
        div(img(src = "Tm_Method.png",class="img-half",alt = "Screenshot showing the Tm Method Selection",style = "clear:both")),
        ...
        div(img(src = "Molecular.png",class="img-half", alt = "Screenshot showing the Molecular Method Selection",style = "clear:both")),
        hr(style = "border-top: 1px solid #000000;"),
        ...
        div(img(src = "Enabled.png",class="img-half",alt = "Screenshot showing the Enabled Navbar",style = "clear:both")),
        hr(style = "border-top: 1px solid #000000;")
      ),
      ...
      div(id = "analysis_graphs_content", hidden = TRUE,
        ...
        div(img(src = "Analysis.png",  class="img-half",alt = "Screenshot showing the Analysis and Graphs  Navbar",style = "clear:both")),
        HTML("This will take you to a page with a series of tab panels, indicating the sample, "),
        div(img(src = "Samples.png",  class="img-half",alt = "Screenshot showing the Samples",style = "clear:both")),
        ...
        div(img(src = "BestFit_Derivative.png",class="img-half", alt = "Screenshot showing the BestFit Derivatives",style = "clear:both")),
        ...
        div(img(src = "Slider.png",class="img-half", alt = "Screenshot showing the Slider",style = "clear:both")),
        hr(style = "border-top: 1px solid #000000;"),
        ...
        div(img(src = "VantHoff_1.png", class="img-half", alt = "Screenshot showing the how to remove box of points",style = "clear:both")),
        div(img(src = "VantHoff_2.png", class="img-half", alt = "Screenshot showing the how to removed box of points",style = "clear:both")),
        HTML("If you want to restore the plot back to the original version, press the restore button on the side panel. "), 
        div(img(src = "Reset.png",  class="img-half", alt = "Screenshot showing the reset option",style = "clear:both")),
        div(img(src = "Points.png", class="img-half", alt = "Screenshot showing the points appearing after clicking on reset button",style = "clear:both")),
        ...
        div(img(src = "Download.png",class="img-half", alt = "Screenshot showing the download option",style = "clear:both")),
      ...
      div(id = "results_table_content", hidden = TRUE,
        ...
        div(img(src = "Download_Table.png",class="img-half", alt = "Screenshot showing the download table option",style = "clear:both")),
